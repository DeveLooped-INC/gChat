...
import { Contact, UserProfile, ToastMessage, ConnectionRequest, Post } from '../types';
import { UserPlus, MapPin, Trash2, QrCode, Upload, Camera, Copy, Check, UserCheck, XCircle } from 'lucide-react';
...
interface ContactsProps {
  ...
  addToast: (t: string, m: string, type: ToastMessage['type']) => void;
...
const Contacts: React.FC<ContactsProps> = ({ 
    currentUser, contacts, requests, onAcceptRequest, onDeclineRequest, onAddContact, onDeleteContact, addToast, onNavigateToChat, onFollowUser, onUnfollowUser, onViewUserPosts, posts
}) => {

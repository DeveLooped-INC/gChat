...
import { CheckCircle, Info, AlertTriangle, AlertCircle, Bell, Check, Trash2, ExternalLink } from 'lucide-react';
...
const Notifications: React.FC<NotificationsProps> = ({ notifications, onClear, onMarkRead, onNotificationClick }) => {
  ...
  return (
    <div className="h-full overflow-y-auto w-full max-w-2xl mx-auto p-4 md:p-8 flex flex-col">

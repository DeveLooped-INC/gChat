...
import { Database, Trash2, HardDrive, Wifi, Activity, ShieldAlert, Loader2, WifiOff, Power, Key, Download, User, RefreshCw, Save, Terminal, FileJson, ToggleLeft, ToggleRight, LogOut, Pause, Play, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto p-4 md:p-8 space-y-8 animate-in fade-in duration-500 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div
          ...
          className={`p-5 rounded-xl border relative overflow-hidden group cursor-pointer transition-all ${
            isOnline
